    ...
    <div className="flex flex-col w-full h-full overflow-hidden">
      <div className="flex-1 overflow-auto">
        <table className="w-full text-left text-sm whitespace-nowrap">
          <thead className="bg-[#0d1117] sticky top-0 shadow-sm text-gray-400 text-xs uppercase tracking-wider z-10">
            <tr>
              {columns.map(k => (
                <th 
                  key={k} 
          ...
          <button 
            ...
            onClick={async () => {
              ...
              try {
                ...
                window.dispatchEvent(new CustomEvent('global-toast', { detail: { message: 'Failed to copy row', type: 'error' } }));
              }
              setContextMenu(null);
            }}
          >
