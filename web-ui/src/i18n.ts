...
const PHRASE_PAIRS: Array<[string, string]> = [
  ...
  ['列', 'Column'],
  ['表达式', 'Expression'],
  ['按此列升序', 'Sort ascending by this column'],
  ['按此列降序', 'Sort descending by this column'],
  ['加入排序组合', 'Add to sort group'],
  ['清除全部排序', 'Clear all sorts'],
  ['打开排序面板', 'Open sort panel'],
  ['排序面板', 'Sort panel'],
  ['排序结果', 'Sort results'],
  ['应用', 'Apply'],
  ['取消', 'Cancel'],
  ...
  ['下移', 'Move down'],
  ['删除', 'Delete'],
  ['Shift 点击可多列排序', 'Shift+click for multi-column sort'],
  ['仅 SELECT 结果支持排序', 'Only SELECT results support sorting'],
  ['非法排序表达式', 'Invalid sort expression'],
  ['表达式不能为空', 'Expression cannot be empty'],
  ['输入排序表达式，如 LENGTH(name)', 'Enter sort expression, e.g. LENGTH(name)'],
  ['选择列…', 'Select column…'],
  ['暂无排序规则', 'No sort rules'],
  ['设置', 'Settings'],
  ['策略与规则', 'Agents & Policy'],
  ['AI 配置', 'AI Profiles'],
  ['数据库与接口', 'Database & API'],
